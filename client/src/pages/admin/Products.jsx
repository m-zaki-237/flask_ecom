  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: `${form.product_name} added to catalog`,
        variant: "success",
      });
    ...
    <AdminLayout>
      <div className="space-y-8 pb-16">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E8E5DF] pb-6">
          <div>
            <span className="text-xs font-bold uppercase tracking-widest text-[#B8865B]">GLOBAL CATALOG</span>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <span className="text-xs font-semibold text-[#52525B]">
            Total Products: <strong className="text-[#1A1A1A]">{filteredProducts.length}</strong>
          </span>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-[#E8E5DF] overflow-hidden shadow-sm">
          {loading ? (
            <div className="p-12 text-center text-xs text-[#71717A] animate-pulse">Loading global catalog...</div>
            ...
            <div className="p-16 text-center space-y-4">
              ...
              <p className="text-xs text-[#6B6B6B]">No products match your current search query.</p>
            </div>
          ) : (
          ...
          <DialogHeader className="pb-4 border-b border-[#E8E5DF] flex flex-row items-center justify-between">
            <div>
              ...
              <DialogDescription className="text-xs text-[#6B6B6B] mt-1">
                Fill out product details to list on Market Bros Marketplace.
              </DialogDescription>
            </div>
